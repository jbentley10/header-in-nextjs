...
const Logo = ({logoWidth, logoClassName, drawAnimations}) => {
  ...
  if (drawAnimations == true) {
    var circleClassName = "cls-1--animate"
    var path1ClassName = "cls-2--animate"
    var path2ClassName = "cls-3--animate"
    var path3ClassName = "cls-4--animate"
  } else {
    var circleClassName = "cls-1"
    var path1ClassName = "cls-2"
    var path2ClassName = "cls-3"
    var path3ClassName = "cls-4"
  }
