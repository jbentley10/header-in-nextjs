...
const ImageTextButtonSplit = () => (
    <div className="image-text-split px-12 text-center bg-dark-background py-24 md:align-middle text-white">        
      <div className="image-text-split__text-container sm:w-full md:w-2/5 text-left sm:inline-block md:align-middle">
        <h3 className="image-text-split__heading text-3xl">It's a pleasure ot meet you.</h3>
      ...
      <div className="image-text-split__image-container sm:text-center sm:my-8 md:my-0 sm:m-auto sm:w-full md:w-2/5 sm:block md:inline-block md:align-middle">
        <img className="rounded-1/2 sm:my-10 md:my-0 sm:h-full sm:w-full md:w-4/6 flex items-center justify-center" src="../static/me-hike.jpg" alt="John Bentley Freelance Web Designer" />
        <img className="rounded-1/2 sm:my-10 md:my-0 sm:h-full sm:w-full md:w-4/6 flex items-center justify-center" src="../static/me-nepal.jpg" alt="John Bentley Freelance Web Designer" />
      </div>
