...
const HeaderFadeInAnimation = (props) => {
  ...
  return (
    <div className="sm:w-full md:flex sm:ml-4 lg:ml-16 xl:mx-64">
      <animated.h1 className="sm:text-5xl md:text-8xl md:inline-block md:w-1/5 text-left md:self-end font-extrabold md:mr-56 lg:leading-tight" style={fadeInQuick}>Create. Analyze. Elevate.</animated.h1>
      <br />
