...
// Import utils
import { fetchTripwirePage } from "../../utils/contentfulPages";
...
export default function Tripwire({ res }) {
  return (
    <div>
      <Layout
        pageMeta={{
          title: "Tripwire - Work - Web Design and Development | John Bentley Creative",
...
export async function getStaticProps() {
  const res = await fetchTripwirePage();
