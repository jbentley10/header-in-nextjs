...
const MainText = () => 
  <div>
    ...
    <p><FontAwesomeIcon icon="envelope" className="text-6xl shadow-none p-4 cursor-pointer inline-block align-middle" /><a href="mailto:jwbentle@gmail.com" className="text-link-purple hover:text-link-purple-darker align-middle"> jwbentle@gmail.com</a></p>
